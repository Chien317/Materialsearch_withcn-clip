...
# Teacher Model: damo/multi-modal_clip-vit-huge-patch14_zh (CLIP huge model)
# Optimized for 4x A800-80GB configuration
# Command: bash run_scripts/muge_finetune_vit-b-16_rbt-base_4gpu_huge_distill.sh
...
checkpoint_dir=/root/autodl-tmp/datapath/experiments/muge_finetune_vit-b-16_roberta-base_bs512_4gpu_huge_distill/checkpoints
...
teacher_model_name="damo/multi-modal_clip-vit-huge-patch14_zh"
kd_loss_weight=0.5

# output options
output_base_dir=/root/autodl-tmp/datapath/experiments/
name=muge_finetune_vit-b-16_roberta-base_bs512_4gpu_huge_distill
