...
# Guide:
# This script supports distributed training on 4 GPU A800 workers
# Optimized for 4x A800-80GB configuration
# Command: bash run_scripts/muge_finetune_vit-b-16_rbt-base_4gpu.sh
...
checkpoint_dir=/root/autodl-tmp/datapath/experiments/muge_finetune_vit-b-16_roberta-base_bs512_4gpu_a800/checkpoints
...
name=muge_finetune_vit-b-16_roberta-base_bs512_4gpu_a800
...
echo "=== 4-GPU A800 Training Configuration ==="
