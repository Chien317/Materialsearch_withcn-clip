...
# Guide:
# This script supports single GPU training without Knowledge Distillation (Baseline)
# Optimized for 1x GPU configuration
# Command: bash run_scripts/muge_finetune_vit-b-16_rbt-base_1gpu_baseline.sh
...
name=muge_finetune_vit-b-16_roberta-base_bs128_1gpu_baseline
...
echo "=== 1-GPU Baseline Training Configuration ==="
echo "Mode: Baseline (No Knowledge Distillation)"
