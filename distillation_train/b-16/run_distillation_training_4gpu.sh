...
# Knowledge Distillation Training Manager - 4GPU Version
# 该脚本管理不同类型的知识蒸馏训练
# 使用方法：./run_distillation_training_4gpu.sh [训练选项号] [服务器]

# 显示菜单
echo "=========================================="
echo "  CN-CLIP 知识蒸馏训练管理器 (4-GPU版本)"
echo "=========================================="
echo "请选择训练类型："
...
case $choice in
    1)
        SCRIPT_NAME="muge_finetune_vit-b-16_rbt-base_4gpu_baseline.sh"
        DESCRIPTION="Baseline training (No Knowledge Distillation) - 4 GPUs"
        ;;
    2)
        SCRIPT_NAME="muge_finetune_vit-b-16_rbt-base_4gpu_huge_distill.sh"
        DESCRIPTION="Knowledge Distillation with CLIP Huge Teacher - 4 GPUs"
        ;;
    3)
        SCRIPT_NAME="muge_finetune_vit-b-16_rbt-base_4gpu_large_distill.sh"
        DESCRIPTION="Knowledge Distillation with CLIP Large Teacher - 4 GPUs"
        ;;
    4)
        SCRIPT_NAME="muge_finetune_vit-b-16_rbt-base_4gpu_team_distill.sh"
        DESCRIPTION="Knowledge Distillation with TEAM Teacher - 4 GPUs"
        ;;
    *)
