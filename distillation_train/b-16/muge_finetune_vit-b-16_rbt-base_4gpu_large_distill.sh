...
# Teacher Model: damo/multi-modal_clip-vit-large-patch14_zh (CLIP large model)
# Optimized for 4x A800-80GB configuration
# Smart Resume: Automatically resumes from checkpoint if available, otherwise starts from pretrained model
# Command: bash run_scripts/muge_finetune_vit-b-16_rbt-base_4gpu_large_distill.sh
...
export MASTER_PORT=29503  # 使用不同端口避免冲突
...
checkpoint_dir=/root/autodl-tmp/datapath/experiments/muge_finetune_vit-b-16_roberta-base_bs512_4gpu_large_distill/checkpoints
...
teacher_model_name="damo/multi-modal_clip-vit-large-patch14_zh"
kd_loss_weight=0.5

# output options
output_base_dir=/root/autodl-tmp/datapath/experiments/
name=muge_finetune_vit-b-16_roberta-base_bs512_4gpu_large_distill
...
echo "Reset Parameters: data_offset=${reset_data_offset}, optimizer=${reset_optimizer}"
echo "==========================================="
